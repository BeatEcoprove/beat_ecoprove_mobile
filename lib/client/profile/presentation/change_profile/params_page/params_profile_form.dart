...
class ParamsProfileForm extends StatelessWidget {
  static const double textFieldsGap = 26;
  final String params;

  const ParamsProfileForm({super.key, required this.params});

  @override
  Widget build(BuildContext context) {
    final viewModel = ViewModel.of<ParamsProfileViewModel>(context);
          ...
          child: Column(
            ...
            children: [
              ...
              FormattedButton(
                ...
                onPress: () async => await viewModel.promoteProfile(params),
              ),
            ],
          ),
        ),
