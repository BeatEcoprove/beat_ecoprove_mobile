...
import 'package:beat_ecoprove/clothing/contracts/current_service_result.dart';
...
class GetCurrentMaintenanceActionRequest {
  ...
  factory GetCurrentMaintenanceActionRequest.fromJson(Map<String, dynamic> json) {
