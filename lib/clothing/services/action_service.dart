...
class ActionService {
  ...
  Future<ServiceResult> getClothAvailableServices(String clothId) async {
    return ServiceResult.fromJson(await _httpClient.makeRequestJson(
      method: HttpMethods.get,
  ...
  Future makeMaintenanceOnCloth(MakeMaintenanceOnClothRequest request) async {
    return await _httpClient.makeRequestJson(
      ...
      path: "profiles/closet/cloth/${request.clothId}/services/${request.serviceId}/perform/${request.actionId}",
      expectedCode: 200,
    );
  }

  Future finishMaintenanceOnCLoth(FinishMaintenanceOnClothRequest request) async {
    return await _httpClient.makeRequestJson(
      method: HttpMethods.post,
      path: "profiles/closet/cloth/${request.serviceId}/services/${request.actionId}/finish",
      expectedCode: 200,
    );
  }

  Future<GetCurrentMaintenanceActionRequest> getCurrentServiceActivity(String clothId) async {
    return GetCurrentMaintenanceActionRequest.fromJson(await _httpClient.makeRequestJson(
      method: HttpMethods.get,
